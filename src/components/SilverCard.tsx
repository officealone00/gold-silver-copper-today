...
const SilverCard = ({ data }: SilverCardProps) => {
  ...
  return (
    <div className="mx-5 price-card">
      <div className="flex items-center gap-2 mb-4">
        <div className="w-8 h-8 rounded-full bg-silver-bg flex items-center justify-center">
          <span className="text-lg">🥈</span>
        </div>
        <div>
          <h2 className="text-base font-bold">오늘 은 시세</h2>
